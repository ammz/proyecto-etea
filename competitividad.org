...
:N::N:
:E::E:
#+CAPTION: Nivel de innovación de Andalucía en comparación con otras CCAA (en relación a la UE)
[[./graficos/0101C2.pdf]]
:END:
...
Asimismo, una destacable proporción de empresas de menos de diez asalariados, el 30%, ni siquiera tiene página web, una proporción que ha mostrado muy poca variación en los últimos años, y que sigue alejada del promedio de los países europeos y del conjunto nacional (en la UE 27 es del 21% y en España del 22%), y bastante distinte de Finlandia o Países Bajos, donde este porcentaje es solo el 4% y 8% respectivamente.
...
:N::N:
:E::E:
#+CAPTION: Trayectoria de las personas trabajadoras autónomas en Andalucía
[[./graficos/0103A3.pdf]]
:END:
